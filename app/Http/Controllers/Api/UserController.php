...
class UserController extends Controller
{
    ...
    public function update(UpdateUserRequest $request, User $user)
    {
        ...
        try {
            ...
            $userData = [
                ...
                'treasury_id' => array_key_exists('treasury_id', $validated) ? $validated['treasury_id'] : $user->treasury_id,
                'bank_id' => array_key_exists('bank_id', $validated) ? $validated['bank_id'] : $user->bank_id,
            ];
    ...
    /**
 * جلب قائمة المستخدمين الذين يحملون دور مصمم فقط
 */
public function getDesigners()
{
    // جلب المستخدمين الذين لديهم دور Designer
    $designers = User::role('Designer')->get();

    // إذا كنت تريد تجربة الشاشة والقائمة فارغة، جرب User::all() للتأكد من وصول البيانات
